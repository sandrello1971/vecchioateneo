...
@section('description', 'INITIUM — 20 ore di formazione AI operativa per manager e team. ChatGPT, Claude, vibe coding, prompt engineering, data governance. Certified AI Productivity User. EU AI Act Art. 4.')
...
<div class="max-w-4xl mx-auto px-4 py-16">
    ...
    <div class="corso-card mb-8">
        ...
        <div class="grid md:grid-cols-2 gap-2">
            ...
            <div class="text-sm p-3 rounded" style="background:#E8F5F5"><strong>M4</strong> Vibe Coding e Claude oltre il browser <span style="color:#8A9696">(4h)</span></div>
