...
<div style="max-width:840px;">
    <a href="{{ route('admin.courses.register', $course) }}" style="font-size:0.8rem; color:#55B1AE; text-decoration:none;">&larr; Registro {{ $course->name }}</a>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:0.85rem;">
            <thead>
                <tr style="text-align:left; color:#6B7280; border-bottom:2px solid #E5E7EB;">
                    <th style="padding:9px 8px;">Quando</th>
                    <th style="padding:9px 8px;">Tipo</th>
                    <th style="padding:9px 8px;">Dettaglio</th>
                    <th style="padding:9px 8px; text-align:right;">Ore</th>
                </tr>
            </thead>
            <tbody>
